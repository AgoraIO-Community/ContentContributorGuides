...
> 
> **IMPORTANT**: The first prerequisite will always include a link to the _“How to get started with Agora”_ tutorial using URL: https://www.agora.io/en/blog/how-to-get-started-with-agora?utm_source=medium&utm_medium=blog&utm_campaign=
> 
> For example:


To successfully understand and complete this task you must have:
...
> Describe the steps to create a new project and set up the environment.
> 
...
> Be sure to explain all inputs and outputs, discuss their significance within the code and how they work together.
> 
> All code snippets should use: 
